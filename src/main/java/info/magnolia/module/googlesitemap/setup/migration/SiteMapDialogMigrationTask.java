...
/**
 * Custom dialog migration task.
 */
public class SiteMapDialogMigrationTask extends DialogMigrationTask {

    public SiteMapDialogMigrationTask(String taskName, String taskDescription, String moduleName) {
    ...
    protected void addCustomDialogActionToCreate(HashMap<String, List<ActionCreator>> dialogActionsToMigrate) {
        // Save
        ActionCreator saveAction = new BaseActionCreator("commit", "save changes", SaveSiteMapActionDefinition.class.getName());
        // Cancel
        ActionCreator cancelAction = new BaseActionCreator("cancel", "cancel", CancelDialogActionDefinition.class.getName());
        // Create an entry
        dialogActionsToMigrate.put("siteComponentTab", Arrays.asList(saveAction, cancelAction));
    }
