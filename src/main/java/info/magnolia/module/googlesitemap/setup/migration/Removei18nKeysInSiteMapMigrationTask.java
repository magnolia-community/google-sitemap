...
/**
 * Remove all i18n properties from the migrated dialog definitions.
 */
public class Removei18nKeysInSiteMapMigrationTask extends AbstractRemoveHardcodedI18nPropertiesTask {


    public Removei18nKeysInSiteMapMigrationTask(String name, String description) {
        super(name, description, Arrays.asList("buttonLabel"));
    }
