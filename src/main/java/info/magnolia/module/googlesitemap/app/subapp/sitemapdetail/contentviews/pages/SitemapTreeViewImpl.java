...
/**
 * Implementation of {@link info.magnolia.module.googlesitemap.app.subapp.sitemapdetail.contentviews.virtualuris.SitemapListView}. Provides {@link SiteMapTreeTable} instead of the
 * stock {@link MagnoliaTreeTable}.
 */
public class SitemapTreeViewImpl extends TreeViewImpl implements SitemapTreeView {

    @Override
    protected MagnoliaTreeTable createTable(Container container) {
        SiteMapTreeTable treeTable = new SiteMapTreeTable();
    ...
    public void setColumnAlignment(Object columnId, Table.Align alignment) {
        asVaadinComponent().setColumnAlignment(columnId, alignment);
    }
}
