...
/**
 * Callback action that open the configuration dialog of a page.<br>
 * Wrap the {@link SiteMapEntry} entry into a {@link BeanItem}. This item is the used by the dialog.
 */
public class EditSiteMapEntryAction extends AbstractAction<EditSiteMapEntryActionDefinition> {
    ...
    @Inject
    protected EditSiteMapEntryAction(EditSiteMapEntryActionDefinition definition, BeanItem<SiteMapEntry> entry, FormDialogPresenterFactory formDialogPresenterFactory, UiContext uiContext, @Named(AdmincentralEventBus.NAME) EventBus eventBus) {
        super(definition);
        this.entry = entry.getBean();
