...
/**
 * Google Sitemap specific browser sub-app descriptor, allows for configuring the caption prefix.
 */
public class SitemapEntryBrowserSubAppDescriptor extends ConfiguredBrowserSubAppDescriptor {
    ...
    public void setCaptionPrefix(String captionPrefix) {
